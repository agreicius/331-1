...
{
  "id": "th_poly_ring_homo",
  "level": "2",
  "url": "s_ring_homo.html#th_poly_ring_homo",
  "type": "Theorem",
  "number": "2.5.7",
...
{
  "id": "d_changecoefficient_evaluation_reduction",
  "level": "2",
  "url": "s_ring_homo.html#d_changecoefficient_evaluation_reduction",
  "type": "Definition",
  "number": "2.5.9",
  "title": "Change of coefficients, reduction, evaluation.",
  "body": " Change of coefficients, reduction, evaluation    change of coefficients of under     reduction of modulo    Let be a nonzero commutative ring.   Change of coefficient  Let be a ring homomorphism. According to , the map is a ring homomorphism. We call this a change of coefficient homomorphism on , and denote : , is the result of applying to the coefficients of .    Reduction modulo  As a special case of the change of coefficient homomorphism, given an ideal and corresponding quotient map , writing for , we call the change of coefficient homomorphism the reduction modulo map. In this setting will often write or for . Moreover, in the special case of a nonzero ideal , we may also write instead of .    Evaluation  Given , the ring homomorphism defined as is called evaluation at map.      "
},
{
  "id": "ss_rings-12",
  "level": "2",
  "url": "s_ring_homo.html#ss_rings-12",
  "type": "Remark",
  "number": "2.5.10",
  "title": "Change of coefficient and evaluation.",
  "body": " Change of coefficient and evaluation  With our new terminology in hand, we can now reformulate as follows: every ring homomorphism , where is commutative, can be written uniquely in the form , where is a ring homomorphism and . In other words the homomorphism decomposes uniquely as follows:   Decomposition of a polynomial ring homomorphism   Decomposition of polynomial ring homomorphism into a change of coefficients and evaluation map     Here by abuse of notation names the change of coefficient map , and is the evaluation at map from to .  "
},
{
...
},
{
  ...
  "type": "Example",
  "number": "2.8.14",
  "title": "Quotients by linear polynomials.",
  "body": " Quotients by linear polynomials   Let be a field, and let be a linear ( , degree-1) polynomial in . Prove: .    Let be the surjective ring homomorphism defined as . Clearly, , and thus . Since is maximal ( is irreducible), and , we have . By the first isomorphism theorem, we conclude that .   "
},
{
...
},
{
  "id": "d_root",
  "level": "2",
  "url": "s_prime_max_poly.html#d_root",
  "type": "Definition",
  "number": "2.8.18",
  "title": "Root of a polynomial.",
  "body": " Root of a polynomial   Let be a nonzero commutative ring, and let be a polynomial. A root of in is an element satisfying .  More generally, let be a commutative -algebra with defining homomorphism . Given , write : , is the result of applying to the coefficients of . A root of in is an element satisfying .   "
},
{
  "id": "th_roots_deg",
  "level": "2",
  "url": "s_prime_max_poly.html#th_roots_deg",
  "type": "Theorem",
  "number": "2.8.19",
  "title": "Degree and distinct roots.",
  "body": " Degree and distinct roots   Let be a field, and let be a nonzero polynomial of degree .    for some if and only if for some . In other words, is a root of if and only if .     has at most distinct roots in .          Fix any , and let be an instance of the division algorithm applied to and , so that or . We have .    By induction on .  Base case: . In this case is a nonzero constant polynomial. Since , clearly for all , and thus has exactly distinct roots.  Induction step: let and assume the claim holds for all nonzero polynomials of degree less than . If has no roots in , then the condition is satisfied and we are done. Otherwise, let be a root of . By (1) we can write for some . Since , we see that . Let be the distinct roots of . By induction, we have . We claim that are the distinct roots of . It is clear that for all . Conversely, assume for some . By (1) we have . Since is irreducible, it is prime, and thus or . In the first case, we have , again by (1), in which case . In the second case, , and . In both cases we have , as desired.  Thus is the set of all roots of . Since , we see that has at most distinct roots.      "
},
{
  "id": "cor_subgrp_field_cyclic",
  "level": "2",
  "url": "s_prime_max_poly.html#cor_subgrp_field_cyclic",
  "type": "Corollary",
  "number": "2.8.20",
  "title": "Finite multiplicative subgroups of fields.",
  "body": " Finite multiplicative subgroups of fields   Let be a field. If is a finite subgroup of , then is cyclic.    Let be a subgroup of of cardinality . Since is a finite abelian group, the invariant factor version of the structure theorem for finite abelian groups implies that where the are positive integers satisfying for all , and is a cyclic group of cardinality . (We are using multiplicative notation, since is a subgroup of the multiplicative group of units.) Since for all , it follows that all elements satisfy . Put another way, the polynomial has at least distinct roots. But in general, a nonzero polynomial has at most distinct roots in . (Why? Using the division algorithm, we have for some if and only if , where . The claim now follows easily by induction of . ) Thus on the one hand, has at most  distinct roots, and on the other hand, it has at least  distinct roots. It follows that . But since , we have , and hence . It follows that and is cyclic, as claimed.   "
},
{
  "id": "s_crt",
  "level": "1",
...
},
{
  "id": "rem_locali",
  "level": "2",
  "url": "s_localization.html#rem_locali",
  "type": "Remark",
  "number": "2.10.5",
  "title": "Localization.",
...
},
{
  ...
  "body": " Kernel of   Let be a multiplicative subset of the nonzero commutative ring , let be a ring homomorphism satisfying , and let be its associated map as in . We have . In particular, if is injective, then so is .    This follows directly from the definition of and the fact that : we have , as desired.   "
},
{
...
{
  "id": "d_primitive_poly_Z",
  "level": "2",
  "url": "s_localization.html#d_primitive_poly_Z",
  "type": "Definition",
  "number": "2.10.19",
  "title": "Primitive polynomial in <span class=\"process-math\">\\(\\Z[x]\\)<\/span>.",
  "body": " Primitive polynomial in   A nonconstant polynomial is primitive if the coefficients of are relatively prime.   "
},
{
  "id": "cor_primes_polyintegers",
  "level": "2",
  "url": "s_localization.html#cor_primes_polyintegers",
  "type": "Corollary",
  "number": "2.10.20",
...
},
{
  ...
  "body": " Euclidean domains are principal   If is a Euclidean domain, then is a principal ideal domain.    This proof is almost identical to the proof that is a PID, as well as the proof that is a PID, where is a field. And for good reason! Both those previous proofs make use of a form of the division algorithm, which is accessible thanks to these rings being Euclidean domains. We reprise the argument in full detail.  Clearly the zero ideal is principal. Let be a nonzero ideal. The set is a nonempty subset of , and accordingly has a least element . Let be an element of satisfying for this minimum value. We claim that . Indeed, since , we have . Next given any , we can write where and either or . Since , and since is the least element of , we must have . But then , showing that . We conclude that , as claimed.   "
},
{
  "id": "s_euc_domain-6",
  "level": "2",
...
},
{
  ...
  "body": " Greatest common divisor and least common multiple   Let be an integral domains. Given elements a greatest common divisor (or GCD ) of and is an element satisfying the following conditions:    and ;    if satisfies and , then .     A least common multiple (or LCM ) of and is an element satisfying the following conditions:    and ;    if satisfies and , then .   More generally, a greatest common divisor of elements of is an element such that for all , and if satisfies for all , then . Lastly, we say that elements are relatively prime if they have as a GCD.   "
},
{
  "id": "s_euc_domain-8",
  "level": "2",
...
},
{
  ...
  "body": " GCD in polynomial ring   Use the Euclidean algorithm to find a GCD of and in the ring , and write , where .    We apply the Euclidean algorithm (using polynomial long division) to the set : . Thus is a GCD of and , and we have .   "
},
{
  "id": "eg_gauss_ints",
  "level": "2",
  ...
  "body": " Ideal generator in   Find a Gaussian integer satisfying and express as for elements .    Since is a Euclidean domain, and hence a PID, we know that is a principal ideal, generated by a GCD of and . Noting that and , we start a Euclidean algorithm by dividing by . . We conclude that is a GCD of and , and hence that . Furthermore, we have .   "
},
{
  "id": "pid_ufd",
  "level": "1",
  ...
  "number": "2.12",
  "title": "PIDs and UFDs",
  "body": " PIDs and UFDs   UFDs   Prime implies irreducible   Let be an integral domain. For all , if is prime, then is irreducible.    Proof by delegation.     PIDs   Let be an element of the principal ideal domain . The following statements are equivalent.    is prime (equivalently, is a prime ideal).     is irreducible.     is maximal.       The proof of this result is identical to that of , which treats the special case of polynomial rings over a field. If you look there, you'll notice that the only thing used is the fact that is a PID when is a field.  For convenience, however, we reprise some of the proof here in cursory form. Implication (1) (2) is true in any commutative ring, as is (3) (1). For the last link, (2) (3), to show that is maximal if is irreducible, we use the fact that is a PID to assert that implies for some . But in that case , in which case either is a unit (and ), or is an associate of , in which case .     is not a PID   Let . Show that the elements and are irreducible, but not prime. Conclude that is not a PID (nor a Euclidean domain).         Unique factorization domain   A unique factorization domain (UFD) is an integral domain that satisfies the following properties.   Factorization into irreducibles  If is nonzero and not a unit, then there are irreducible elements in satisfying .    Uniqueness of factorization  The factorization is unique in the following sense: if we have , where the and are irreducible, then , and after a reordering there are units such that for all . In other words, in any factorization of into irreducibles, the number of irreducible factors is constant, and the irreducible elements appearing in the factorization are unique up to multiplication by a unit.        UFDs   Let be an element of the unique factorization domain . The following statements are equivalent.    is prime (equivalently, is a prime ideal).     is irreducible.       Since (1) (2) is true in any commutative ring, it suffices to show (2) (1).  Assume is irreducible, and that for some elements . This means we have for some . Let be an irreducible factorization of , so that is an irreducible factorization of . This shows that is (up to multiplication by a unit) one of the irreducible elements appearing in the factorization of . Since we can also obtain an irreducible factorization of by taking the product of the two irreducible factorizations of and , it follows that must be associate to one of the irreducible factors of or of , and thus that or .     Irreducible is prime in UFD  According to , in a UFD, the notions of irreducible and prime elements are equivalent. Accordingly, we are tempted to treat the two terms as synonymous when working in a UFD. Since however, the two properties are not generally equivalent for integral domains, we will do our best to resist this temptation.    Valuation at irreducible   Let be a unique factorization domain.   Given a nonzero element and an irreducible element , there is a unique nonnegative integer such that , where and . Equivalently, is the largest nonnegative integer such that .     for all irreducible elements and nonzero elements and .    Given nonzero elements and , we have if and only if for all irreducible elements .    A nonzero element is a unit if and only if for all irreducible elements .    If and are associate irreducible elements, for all nonzero elements .       The proof is left as an exercise.     Valuation at irreducible   Let be a unique factorization domain, and let be an irreducible element of . Given a nonzero element , the valuation of at , denoted , is the largest nonnegative integer satisfying .     Irreducible factorization and divisibility   Let be a unique factorization domain.   Given a nonzero non-unit element , we can write where , the are pairwise non-associate irreducible elements, and .    Assume nonzero elements can be written as where and nonnegative integers, and the are pairwise non-associate irreducible elements.  The element is a GCD of and , and the element is an LCM of and .          Write to denote that and are associates in . This relation is easily seen to be an equivalence relation. Given an irreducible factorization , let be any representatives of the distinct associate classes of the . Sorting the by their associate classes, we have , where and is the number of factors that are associates of .  Fix and write . Since is not associate to for , it follows that , and hence that .    Given factorizations of and as specified, first observe that for all not associate to one of the . It follows that is a common divisor of and if and only if for all , and for all not associate to one of the , if and only if , where . This shows is a GCD of and . A similar argument shows that the given is a LCM of and .        PID implies UFD   If is a principal ideal domain, then is a unique factorization domain.     Proof of uniqueness  The existence of irreducible factorizations is the trickier argument. Let's look at uniqueness, assuming existence. Let be an irreducible factorization of the nonzero, non-unit element . We prove the uniqueness property of this factorization by induction on . If , then is irreducible. Suppose we have another factorization . First observe that we must have . Otherwise, we would have , where and are both non-units, contradicting the fact that is irreducible.  Assume now that the uniqueness property holds for all irreducible factorizations into irreducible factors, and assume , with . If we have another factorization , then by induction we must have . Since divides the product of the , and since is prime (irreducible implies prime in PIDs), must divide one of the . Without loss of generality, we may assume that . Since is irreducible and is not a unit, we conclude that for some unit. But then we can cancel from both sides to obtain . Since is a product of irreducible elements, we may apply induction to conclude that , and after a reordering, is associate to for all . (Note that the presence of instead of here is not an issue here, since being associates is an equivalence relation.) But then we have , and is associate to for all , as desired.    Proof of existence  Suppose, by contradiction that there is a nonzero, non-unit element that does not admit an irreducible factorization. Since, in particular, cannot be irreducible, we have for two non-unit elements , and at least one of and fails to admit an irreducible factorization (otherwise would have an irreducible factorization). Call this element , and proceed in the same way to produce a sequence satisfying and for all , and hence a chain of strictly proper inclusions . It is easy to see that is an ideal of . Since is a PID, we have for some element . But then for some , from whence it follows that , and . A contradiction! We conclude that every nonzero, non-unit element of does admit an irreducible factorization.  Note: it is possible to give a proof of existence that uses Zorn's lemma. Can you produce it? The one we provide has the advantage of not using Zorn's lemma, which you will recall is equivalent to the axiom of choice. If you look closely, however, you will see that our proof does involve some fishy choices to construct the sequence . Indeed, it is making use of what is called the axiom of dependent choice (DC), which is logically weaker than the full axiom of choice.     Looking at the proof of the uniqueness of irreducible factorizations in PIDs, we see that the only property we used, assuming that factorizations exist, is that irreducible elements are prime. This is a useful shortcut for proving that a given integral domain is a UFD, and so we extract it as its own result.   Uniqueness of factorizations   Let be an integral domain, and assume that irreducible factorizations exist in . If every irreducible element of is prime, then is a unique factorization domain.      PIDs and UFDs among quadratic rings of integers  In the past three sections we have established the chain of implications . As always in mathematics, when confronted with a stated implication, we should ask whether the converse is also true. No implication in the chain above is an equivalence. Let's assemble some counterexamples:   We have seen that the ring is integral, but not a UFD, since not all irreducible elements are prime.    Soon we will see that the ring is a UFD, but it is not a PID: it is easy to see that is not a principal ideal.    As mentioned earlier, the ring , where is a PID, but not a Euclidean domain (see the Dummit and Foote text).      Quadratic ring of integers  Let be a square-free integer. We have seen that is a field. The ring of integers  of is defined as , where . This family of rings provides a nice testing ground for exploring Euclidean domains, PIDs, and UFDs, in that the rings are fairly well behaved, and yield examples that distinguish between these various types of integral domains. Below you find a summary of what is currently known about the rings .   For all square-free integers , is a PID if and only if it is a UFD. Thus we need not cast our net among this family of rings to find examples of UFDs that are not PIDs.    If is negative , then is a PID if and only if , an is a Euclidean domain if and only if .    Turning to the positive case, it is conjectured, but not known, that there are infinitely many positive square-free integers such that is a PID. Sequence A003172 on the Online Encylopedia of Infinite Sequences (OEIS) is an updated list of the known examples of positive for which is a PID.    Continuing with positive case. It is known that with the possible exception of two values of positive, square-free integers , is a PID if and only if it is a Euclidean domain. Additionally, the generalized Riemann hypothesis implies that for positive square-free , is a PID if and only if it is a Euclidean domain.       "
},
{
  "id": "prop_prime_implies_irr",
  "level": "2",
  "url": "pid_ufd.html#prop_prime_implies_irr",
  "type": "Proposition",
  "number": "2.12.1",
  "title": "Prime implies irreducible.",
  "body": " Prime implies irreducible   Let be an integral domain. For all , if is prime, then is irreducible.    Proof by delegation.   "
},
{
  "id": "th_PID",
  "level": "2",
  "url": "pid_ufd.html#th_PID",
  "type": "Theorem",
  "number": "2.12.2",
  "title": "PIDs.",
  "body": " PIDs   Let be an element of the principal ideal domain . The following statements are equivalent.    is prime (equivalently, is a prime ideal).     is irreducible.     is maximal.       The proof of this result is identical to that of , which treats the special case of polynomial rings over a field. If you look there, you'll notice that the only thing used is the fact that is a PID when is a field.  For convenience, however, we reprise some of the proof here in cursory form. Implication (1) (2) is true in any commutative ring, as is (3) (1). For the last link, (2) (3), to show that is maximal if is irreducible, we use the fact that is a PID to assert that implies for some . But in that case , in which case either is a unit (and ), or is an associate of , in which case .   "
},
{
  "id": "eg_5i",
  "level": "2",
  "url": "pid_ufd.html#eg_5i",
  "type": "Example",
  "number": "2.12.3",
  "title": "<span class=\"process-math\">\\(\\Z[\\sqrt{-5}]\\)<\/span> is not a PID.",
  "body": " is not a PID   Let . Show that the elements and are irreducible, but not prime. Conclude that is not a PID (nor a Euclidean domain).       "
},
{
  "id": "d_ufd",
  "level": "2",
  "url": "pid_ufd.html#d_ufd",
  "type": "Definition",
  "number": "2.12.4",
  "title": "Unique factorization domain.",
  "body": " Unique factorization domain   A unique factorization domain (UFD) is an integral domain that satisfies the following properties.   Factorization into irreducibles  If is nonzero and not a unit, then there are irreducible elements in satisfying .    Uniqueness of factorization  The factorization is unique in the following sense: if we have , where the and are irreducible, then , and after a reordering there are units such that for all . In other words, in any factorization of into irreducibles, the number of irreducible factors is constant, and the irreducible elements appearing in the factorization are unique up to multiplication by a unit.      "
},
{
  "id": "th_ufds",
  "level": "2",
  "url": "pid_ufd.html#th_ufds",
  "type": "Theorem",
  "number": "2.12.5",
  "title": "UFDs.",
  "body": " UFDs   Let be an element of the unique factorization domain . The following statements are equivalent.    is prime (equivalently, is a prime ideal).     is irreducible.       Since (1) (2) is true in any commutative ring, it suffices to show (2) (1).  Assume is irreducible, and that for some elements . This means we have for some . Let be an irreducible factorization of , so that is an irreducible factorization of . This shows that is (up to multiplication by a unit) one of the irreducible elements appearing in the factorization of . Since we can also obtain an irreducible factorization of by taking the product of the two irreducible factorizations of and , it follows that must be associate to one of the irreducible factors of or of , and thus that or .   "
},
{
  "id": "ss_pid_implies_ufd-7",
  "level": "2",
  "url": "pid_ufd.html#ss_pid_implies_ufd-7",
  "type": "Remark",
  "number": "2.12.6",
  "title": "Irreducible is prime in UFD.",
  "body": " Irreducible is prime in UFD  According to , in a UFD, the notions of irreducible and prime elements are equivalent. Accordingly, we are tempted to treat the two terms as synonymous when working in a UFD. Since however, the two properties are not generally equivalent for integral domains, we will do our best to resist this temptation.  "
},
{
  "id": "prop_valutation_irr",
  "level": "2",
  "url": "pid_ufd.html#prop_valutation_irr",
  "type": "Proposition",
  "number": "2.12.7",
  "title": "Valuation at irreducible.",
  "body": " Valuation at irreducible   Let be a unique factorization domain.   Given a nonzero element and an irreducible element , there is a unique nonnegative integer such that , where and . Equivalently, is the largest nonnegative integer such that .     for all irreducible elements and nonzero elements and .    Given nonzero elements and , we have if and only if for all irreducible elements .    A nonzero element is a unit if and only if for all irreducible elements .    If and are associate irreducible elements, for all nonzero elements .       The proof is left as an exercise.   "
},
{
  "id": "d_valuation_at_irr",
  "level": "2",
  "url": "pid_ufd.html#d_valuation_at_irr",
  "type": "Definition",
  "number": "2.12.8",
  "title": "Valuation at irreducible.",
  "body": " Valuation at irreducible   Let be a unique factorization domain, and let be an irreducible element of . Given a nonzero element , the valuation of at , denoted , is the largest nonnegative integer satisfying .   "
},
{
  "id": "prop_ufd_prime_fact",
  "level": "2",
  "url": "pid_ufd.html#prop_ufd_prime_fact",
  "type": "Proposition",
  "number": "2.12.9",
  "title": "Irreducible factorization and divisibility.",
  "body": " Irreducible factorization and divisibility   Let be a unique factorization domain.   Given a nonzero non-unit element , we can write where , the are pairwise non-associate irreducible elements, and .    Assume nonzero elements can be written as where and nonnegative integers, and the are pairwise non-associate irreducible elements.  The element is a GCD of and , and the element is an LCM of and .          Write to denote that and are associates in . This relation is easily seen to be an equivalence relation. Given an irreducible factorization , let be any representatives of the distinct associate classes of the . Sorting the by their associate classes, we have , where and is the number of factors that are associates of .  Fix and write . Since is not associate to for , it follows that , and hence that .    Given factorizations of and as specified, first observe that for all not associate to one of the . It follows that is a common divisor of and if and only if for all , and for all not associate to one of the , if and only if , where . This shows is a GCD of and . A similar argument shows that the given is a LCM of and .      "
},
{
  "id": "th_pid_implies_ufd",
  "level": "2",
  "url": "pid_ufd.html#th_pid_implies_ufd",
  "type": "Theorem",
  "number": "2.12.10",
...
{
  "id": "lem_unique_factorizations",
  "level": "2",
  "url": "pid_ufd.html#lem_unique_factorizations",
  "type": "Lemma",
  "number": "2.12.11",
  "title": "Uniqueness of factorizations.",
  "body": " Uniqueness of factorizations   Let be an integral domain, and assume that irreducible factorizations exist in . If every irreducible element of is prime, then is a unique factorization domain.   "
},
{
...
},
{
  ...
  "type": "Theorem",
  "number": "2.13.5",
  "title": "Factorization of integer primes in <span class=\"process-math\">\\(\\Z[i]\\)<\/span>.",
  "body": " Factorization of integer primes in   Let be a prime integer. The following statements are equivalent.    is not prime (equivalently, irreducible) in .     for integers .     for some irreducible element .     is a reducible polynomial in .     is a square in ( , is a square modulo ).     or .       Since , and since implies is irreducible, (2) and (3) are clearly equivalent. Furthermore, we know implies (1) by .  Let's prove that (1) implies (3). Assume is not prime\/irreducible in . It follows that we have for some non-units . From , it follows that : otherwise, one of or would have norm equal to 1, making it a unit. Thus , and since is irreducible in , we conclude that is irreducible.  It remains to show that (1), (4), (5), and (6) are all equivalent. First note that (4) and (5) are equivalent since a quadratic polynomial in is reducible if and only if it has a root in . (See .) Thus is reducible in if and only if for some if and only if .  We now show that (1) and (4) are equivalent, by proving is prime in if and only if is irreducible in . We will do so by looking at . First since is a nonzero ideal of , and is a PID, we have prime if and only if maximal, if and only if is a field. We claim that . Since is also a UFD, from the claim we conclude that is prime if and only if is irreducible, as desired.  To prove the claim, first note that . We leave it to the reader to show that in fact is a well-defined isomorphism. Next, from this isomorphism it follows that where is the image of under the quotient map . This quotient of quotients situation should remind you of the third isomorphism theorem. Indeed, setting and , we see that the ring on the right is of the form for the ideal of . But to apply the third isomorphism theorem, we need an ideal that contains the ideal . This is easily amended: we replace with . Now all the conditions are met, and we have . Lastly, we apply the same third isomorphism theorem maneuver to conclude .  Finally, we show that (5) and (6) are equivalent. This result falls into a category of similar results from number theory that relate the existence of certain square roots modulo to congruence relations modulo . The one under review, that is a square in if and only if or , can be easily proved with some group theory. First, we dispense with the case : since it follows easily that is a square in . It remains to show that for odd prime , is a square in if and only if . First note that if satisfies , then , , and . It follows that is a square in if and only if has an element of order . Finally by , since is a cyclic group, it has an element of order if and only if if and only if .   "
},
{
...
},
{
  "id": "d_lying_over",
  "level": "2",
  "url": "s_gaussian_integers.html#d_lying_over",
  "type": "Definition",
  "number": "2.13.6",
  "title": "Lying over.",
  "body": " Lying over   Let be a quadratic ring of integers. We say an irreducible element  lies over the prime integer if . More generally, we say that a prime ideal of lies over the prime integer if .   "
},
{
  ...
  "type": "Corollary",
  "number": "2.13.7",
  "title": "Irreducible elements of <span class=\"process-math\">\\(\\Z[i]\\)<\/span>.",
  "body": " Irreducible elements of   Every irreducible element of lies over a unique prime integer . Up to associates, the distinct irreducible elements of are described below based on the prime they lie over.   Case:  Up to associates, is the unique irreducible element of lying over .    Case:  If , then there are exactly two irreducible elements lying over up to associates: namely, and , where is any pair of integers satisfying .    Case:  If , then is irreducible in , and is the unique irreducible element of lying over , up to associates.       Let . We have . Since , which is prime, both and are irreducible. Furthermore, since , we see that and are associates. If is an irreducible element lying over , so that , then we must have . Since is irreducible, it follows that and are associates. Thus is, up to associates, the unique irreducible element lying over .  Let . By , there are integers and satisfying . The same argument as above shows that and are the only irreducible elements lying over , up to associates. Since , and , it follows easily that we cannot have , and hence that for any unit . In other words, and are not associates.  Let . By , is itself irreducible in , and thus any irreducible element lying over must be an associate to . Thus , and so lies over . If is an irreducible element lying over , then we have . Since is irreducible, it follows that and are associates. Thus, up to associates, the unique irreducible element lying over is .   "
},
{
  "id": "ss_gauss_integers-7",
  "level": "2",
  "url": "s_gaussian_integers.html#ss_gauss_integers-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "fig_specZ_specZi",
  "level": "2",
  "url": "s_gaussian_integers.html#fig_specZ_specZi",
  "type": "Figure",
  "number": "2.13.8",
  "title": "",
...
{
  "id": "cor_integer_sum_squares",
  "level": "2",
  "url": "s_gaussian_integers.html#cor_integer_sum_squares",
  "type": "Corollary",
  "number": "2.13.9",
...
},
{
  ...
  "body": " Primitive polynomials   Let be a unique factorization domain. A nonconstant polynomial is primitive if the the coefficients are relatively prime ( , if is a greatest common divisor of ).   "
},
{
  "id": "th_gauss_lemma",
  "level": "2",
...
},
{
  ...
  "level": "2",
  "url": "s_poly_general.html#prop_monomial_expansion",
  "type": "Proposition",
  "number": "2.15.3",
  "title": "Monomial expansion.",
  "body": " Monomial expansion   Let be a nonzero commutative ring, and let be a positive integer. Every polynomial can be written in the form , where for all , and for all but finitely many indices .  Moreover, this representation is unique in the following sense: if , are monomial expansions as in , then for all .    The proof is by induction on .  Base step: . The statement in this case is just a reformulation of the definition of .  Induction step: assume and that the statement holds for all polynomial rings in variables. By definition, an element can be expressed in the form , where . By induction, for each we have , and thus . Summing the terms yields a monomial expansion of as described in the statement of the proposition. We now show that this expansion is unique. Suppose we have monomial expansions . For each , let , let , and let . We have , and similarly . By definition of , and in particular corresponding notion of equality in this ring, we conclude that . Since the line above is an equality of monomial expansions in the ring , the induction hypothesis implies for all and all satisfying . But for all , there is a such that . Thus for all , as desired.   "
},
{
  "id": "th_map_prop_multi_poly",
  "level": "2",
  "url": "s_poly_general.html#th_map_prop_multi_poly",
  "type": "Theorem",
  "number": "2.15.4",
  "title": "Homomorphisms from <span class=\"process-math\">\\(R[\\boldx]\\)<\/span>.",
  "body": " Homomorphisms from   Let be a nonzero commutative ring, let be a positive integer, let , and let be a commutative ring. A ring homomorphism is uniquely determine by its restriction to (considered as a subring of ) and the tuple of images . Conversely, given a pair , where is a ring homomorphism and , the map is a ring homomorphism. As a result, we have a bijection between and , described as follows.   Description of multivariate polynomial ring homomorphisms      Left as an exercise. Use a proof by induction along the lines used in the proofs for the two results above.   "
},
{
...
},
{
  ...
  "body": " Hilbert's basis theorem   If is a Noetherian ring, then so is .    It is clear that the zero ideal is finitely generated. Let be any nonzero ideal . Define the following subsets of : . It is straightforward to show the sets and are in fact ideals of . The general idea used for both cases is the following: if is the leading coefficient of and is the leading coefficient of , then is either equal to zero, or is the leading coefficient of ; and is either equal to zero, or is the leading coefficient of for any .  By assumption, is Noetherian. Thus we have , where is the leading coefficient of some polynomial for all , and similarly, is the leading coefficient of some polynomial of degree . Let , and define . We claim that , and hence that is finitely generated, since is a finite set. It is clear that , since . Assume by contradiction that is nonempty. It follows that there is an element (necessarily nonzero) of minimal degree.  Case 1: . Let . By assumption for all . The leading coefficient of is an element of , and thus can be expressed as for some . Let . Note that , from whence it follows that (since otherwise ). But then is an element of of degree less than , contradicting the choice of .  Case 2: . In this case the leading coefficient of is an element of , where , and similarly as above, the poly   "
},
{
...
},
{
  ...
  "body": " Failure of division algorithm   Let be a nonzero commutative ring.   Establish an isomorphisn between and a familiar ring.    Show that we cannot write as for any with .          "
},
{
  "id": "d_monoid",
  "level": "2",
...
{
  "id": "spec_polynomials_in_monoid",
  "level": "2",
  "url": "s_poly_general.html#spec_polynomials_in_monoid",
  "type": "Specimen",
  "number": "33",
  "title": "Monoid algebra.",
  "body": " Monoid algebra   Let be a nonzero commutative ring, and let be a monoid. Define to be the set of all formal expressions where for all but finitely many . We define binary operations and on as follows: . Note that the sum defining is in fact finite, since only finitely many of the products are nonzero. The triple is a ring called the monoid algebra of over .   "
},
{
  "id": "s_integral_domain_factorization",
  "level": "1",
  "url": "s_integral_domain_factorization.html",
  "type": "Section",
  "number": "2.16",
  "title": "Factorization over integral domains",
  "body": " Factorization over integral domains  Gauss's lemma is one important tool for answering factorization questions about polynomials where is a UFD. Roughly speaking, the main result there is that we investigate factorization in this context by comparing factorization in with factorization in .  In this section we add a couple of additional tools that can be used for arbitrary integral domains (that need not be UFDs). First a simple lemma about factorization of monic polynomials in for an arbitrary nonzero commutative ring .    Let be a nonzero commutative ring. If is a monic polynomial, then if factors as a product of two polynomials in , then it factors as a product of two monic polynomials.    Proof be delegation.     Reduction modulo   Let be an integral domain, and let be a nonconstant monic polynomial in . If there is a proper ideal of such that the reduction cannot be factored as a product of two polynomials of smaller degree, then is irreducible in .  In the special case where is a prime ideal of , the condition that cannot be factored as a product of two polynomials of smaller degree is equivalent to being irreducible.    Given and as in the statement, suppose by contradiction that is reducible. In that case, since is monic, we can write for polynomials . Since is monic the products of the leading coefficients of and is . It follows that these leading coefficients are units in , and thus we factor them out of      Monic is important  The condition that be monic is important here. Note that is irreducible modulo , but is reducible in .  As another illuminating example in this regard, consider . We have , which clearly cannot be factored as a product of two polynomials of smaller degree. However we have in .    Nondefinitive irreducibility test  It is important to note that only gives us a partial or nondefinitive test for irreducibility. That is, with the setup of the theorem, if does not factor as a product as a polynomial of smaller degree, then is irreducible. However, there is no useful converse to this statement. For example, it is not true that if is reducible in for all prime ideals then is reducible in ; nor is this true if we look at for all nontrivial ideals (prime or otherwise).  Indeed you will show in homework the the polynomial is irreducible, and yet is reducible in for all prime integers . By the way, in this case it is not true that is reducible modulo all nonzero integers : indeed, you can show that is irreducible in in a straightforward manner.  Similarly, it is possible (but more difficult) to show that is irreducible modulo for all nonzero integers , and yet is irreducible in .    Reduction mod : cubic   Decide whether is irreducible.    Since and is primitive, irreducibility of in is equivalent to irreducibility of in . We investigate the latter by examining for various prime integers .  We have , which is reducible: $x^3+1=(x+1)(x^2+x+1)$ in .  We have , which is irreducible. Indeed, since the degree is 3, it suffices to check that this polynomial has no roots in , which is easy to verify.  Since is irreducible, we conclude that is irreducible in , and thus also in .     Reduction mod : quartic   Let . Decide whether is irreducible in .    Again, by Gauss's lemma and its consequences, is irreducible in if and only if is irreducible in .  We have . We claim in . It is easily verified that it has no roots, so if it factored, we would have in . Expanding the product out and comparing coefficients with , we would have . Using the very simple arithmetic of , we see that the last equation implies . But then the third equation becomes . But this contradicts the first equation, which implies . We conclude there is no such factorization, and that is irreducible over . It follows that is irreducible in , and hence also in .    The following irreducibilty criterion is strictly speaking a corollary of , but it is famous enough to warrant the theorem designation.   Eisenstein's criterion   Let be an integral domain, and let be a nonconstant monic polynomial of . If is a prime ideal of satisfying    for all ,     ,   then is irreducible in .    Suppose by contradiction that is reducible. Since is monic, we may assume that , where , are both monic and . It follows that modulo we have , where , . It is not difficult to see that since is an integral domain, we must have : indeed, if , then has a nonzero term of degree ; if , then has a nonzero term of degree . It follows that and , and thus , contradicting our assumption! Thus is irreducible.    It's great when Eisenstein's criterion can be used, but its scope of application is unfortunately somewhat narrow, as the following somewhat artificial examples illustrate.   Eisenstein   Show that the given is irreducible.                    is Eisenstein with respect to the prime ideal , thus irreducible. Note that is not Eisenstein with respect to or .     is Eisenstein with respect to the prime ideal in . Note that is not prime in , and is not Eisenstein with respect to the prime ideal lying over , since .        Eisenstein: -th roots in UFD   Let be a UFD, and let satisfy for all irreducible elements . Show that is irreducible in for any positive integer .    In general, for any element and irreducible element , setting , we have . Since is not a unit and for all irreducible elements , there is some irreducible element such that . It follows that , and thus that is Eisenstein with respect to , making it irreducible.    Occasionally we can make indirect use of Eisenstein's criterion, as the next result illustrates.   Cyclotomic polynomial: prime   Let be a prime integer and let .    is irreducible in .    Let , and let , the subring of generated over by . We have . In particular, is a subfield of of dimension as a -vector space.            Primitive roots of unity  In general, given positive integer , the complex number is called a primitive -th root of unity . This is because as an element of , we have . As with prime integers the set is in fact a subfield of that we call the -th cyclotomic extension of . Since it is a -algebra, it has a well-defined dimension as a -vector space. For , the result above tells us that the -th cyclotomic extension has -dimension . What do you think the dimension is for general ? You guessed it: . This will be one of the big results of the field theory portion of this course.   "
},
{
  "id": "lem_monic_factorization",
  "level": "2",
  "url": "s_integral_domain_factorization.html#lem_monic_factorization",
  "type": "Lemma",
  "number": "2.16.1",
  "title": "",
  "body": "  Let be a nonzero commutative ring. If is a monic polynomial, then if factors as a product of two polynomials in , then it factors as a product of two monic polynomials.    Proof be delegation.   "
},
{
  "id": "th_reduction_mod_I",
  "level": "2",
  "url": "s_integral_domain_factorization.html#th_reduction_mod_I",
  "type": "Theorem",
  "number": "2.16.2",
  "title": "Reduction modulo <span class=\"process-math\">\\(I\\)<\/span>.",
  "body": " Reduction modulo   Let be an integral domain, and let be a nonconstant monic polynomial in . If there is a proper ideal of such that the reduction cannot be factored as a product of two polynomials of smaller degree, then is irreducible in .  In the special case where is a prime ideal of , the condition that cannot be factored as a product of two polynomials of smaller degree is equivalent to being irreducible.    Given and as in the statement, suppose by contradiction that is reducible. In that case, since is monic, we can write for polynomials . Since is monic the products of the leading coefficients of and is . It follows that these leading coefficients are units in , and thus we factor them out of    "
},
{
  "id": "s_integral_domain_factorization-6",
  "level": "2",
  "url": "s_integral_domain_factorization.html#s_integral_domain_factorization-6",
  "type": "Remark",
  "number": "2.16.3",
  "title": "Monic is important.",
  "body": " Monic is important  The condition that be monic is important here. Note that is irreducible modulo , but is reducible in .  As another illuminating example in this regard, consider . We have , which clearly cannot be factored as a product of two polynomials of smaller degree. However we have in .  "
},
{
  "id": "s_integral_domain_factorization-7",
  "level": "2",
  "url": "s_integral_domain_factorization.html#s_integral_domain_factorization-7",
  "type": "Remark",
  "number": "2.16.4",
  "title": "Nondefinitive irreducibility test.",
  "body": " Nondefinitive irreducibility test  It is important to note that only gives us a partial or nondefinitive test for irreducibility. That is, with the setup of the theorem, if does not factor as a product as a polynomial of smaller degree, then is irreducible. However, there is no useful converse to this statement. For example, it is not true that if is reducible in for all prime ideals then is reducible in ; nor is this true if we look at for all nontrivial ideals (prime or otherwise).  Indeed you will show in homework the the polynomial is irreducible, and yet is reducible in for all prime integers . By the way, in this case it is not true that is reducible modulo all nonzero integers : indeed, you can show that is irreducible in in a straightforward manner.  Similarly, it is possible (but more difficult) to show that is irreducible modulo for all nonzero integers , and yet is irreducible in .  "
},
{
  "id": "eg_reduction_mod_I_cubic",
  "level": "2",
  "url": "s_integral_domain_factorization.html#eg_reduction_mod_I_cubic",
  "type": "Example",
  "number": "2.16.5",
  "title": "Reduction mod <span class=\"process-math\">\\(I\\text{:}\\)<\/span> cubic.",
  "body": " Reduction mod : cubic   Decide whether is irreducible.    Since and is primitive, irreducibility of in is equivalent to irreducibility of in . We investigate the latter by examining for various prime integers .  We have , which is reducible: $x^3+1=(x+1)(x^2+x+1)$ in .  We have , which is irreducible. Indeed, since the degree is 3, it suffices to check that this polynomial has no roots in , which is easy to verify.  Since is irreducible, we conclude that is irreducible in , and thus also in .   "
},
{
  "id": "eg_reduction_mod_I_quartic",
  "level": "2",
  "url": "s_integral_domain_factorization.html#eg_reduction_mod_I_quartic",
  "type": "Example",
  "number": "2.16.6",
  "title": "Reduction mod <span class=\"process-math\">\\(I\\text{:}\\)<\/span> quartic.",
  "body": " Reduction mod : quartic   Let . Decide whether is irreducible in .    Again, by Gauss's lemma and its consequences, is irreducible in if and only if is irreducible in .  We have . We claim in . It is easily verified that it has no roots, so if it factored, we would have in . Expanding the product out and comparing coefficients with , we would have . Using the very simple arithmetic of , we see that the last equation implies . But then the third equation becomes . But this contradicts the first equation, which implies . We conclude there is no such factorization, and that is irreducible over . It follows that is irreducible in , and hence also in .   "
},
{
  "id": "th_Eisenstein",
  "level": "2",
  "url": "s_integral_domain_factorization.html#th_Eisenstein",
  "type": "Theorem",
  "number": "2.16.7",
  "title": "Eisenstein’s criterion.",
  "body": " Eisenstein's criterion   Let be an integral domain, and let be a nonconstant monic polynomial of . If is a prime ideal of satisfying    for all ,     ,   then is irreducible in .    Suppose by contradiction that is reducible. Since is monic, we may assume that , where , are both monic and . It follows that modulo we have , where , . It is not difficult to see that since is an integral domain, we must have : indeed, if , then has a nonzero term of degree ; if , then has a nonzero term of degree . It follows that and , and thus , contradicting our assumption! Thus is irreducible.   "
},
{
  "id": "eg_eisenstein_z",
  "level": "2",
  "url": "s_integral_domain_factorization.html#eg_eisenstein_z",
  "type": "Example",
  "number": "2.16.8",
  "title": "Eisenstein.",
  "body": " Eisenstein   Show that the given is irreducible.                    is Eisenstein with respect to the prime ideal , thus irreducible. Note that is not Eisenstein with respect to or .     is Eisenstein with respect to the prime ideal in . Note that is not prime in , and is not Eisenstein with respect to the prime ideal lying over , since .      "
},
{
  "id": "eg_eisenstein_nth_root",
  "level": "2",
  "url": "s_integral_domain_factorization.html#eg_eisenstein_nth_root",
  "type": "Example",
  "number": "2.16.9",
  "title": "Eisenstein: <span class=\"process-math\">\\(n\\)<\/span>-th roots in UFD.",
  "body": " Eisenstein: -th roots in UFD   Let be a UFD, and let satisfy for all irreducible elements . Show that is irreducible in for any positive integer .    In general, for any element and irreducible element , setting , we have . Since is not a unit and for all irreducible elements , there is some irreducible element such that . It follows that , and thus that is Eisenstein with respect to , making it irreducible.   "
},
{
  "id": "th_pth_cyclo",
  "level": "2",
  "url": "s_integral_domain_factorization.html#th_pth_cyclo",
  "type": "Theorem",
  "number": "2.16.10",
  "title": "Cyclotomic polynomial: <span class=\"process-math\">\\(p\\)<\/span> prime.",
  "body": " Cyclotomic polynomial: prime   Let be a prime integer and let .    is irreducible in .    Let , and let , the subring of generated over by . We have . In particular, is a subfield of of dimension as a -vector space.          "
},
{
  "id": "s_integral_domain_factorization-17",
  "level": "2",
  "url": "s_integral_domain_factorization.html#s_integral_domain_factorization-17",
  "type": "Remark",
  "number": "2.16.11",
  "title": "Primitive roots of unity.",
  "body": " Primitive roots of unity  In general, given positive integer , the complex number is called a primitive -th root of unity . This is because as an element of , we have . As with prime integers the set is in fact a subfield of that we call the -th cyclotomic extension of . Since it is a -algebra, it has a well-defined dimension as a -vector space. For , the result above tells us that the -th cyclotomic extension has -dimension . What do you think the dimension is for general ? You guessed it: . This will be one of the big results of the field theory portion of this course.  "
},
{
  "id": "s_modules",
  "level": "1",
...
},
{
  "id": "eg_module_field",
  "level": "2",
  "url": "s_modules.html#eg_module_field",
  "type": "Example",
  "number": "2.17.3",
  "title": "Modules over fields.",
  "body": " Modules over fields   Let be a field. An -module is the same thing as a vector space over . Indeed, modules should be considered as a straightforward generalization of a vector space, where the base field of the vector space is replaced with an arbitrary ring.   "
},
{
  "id": "eg_module_Z",
  "level": "2",
  "url": "s_modules.html#eg_module_Z",
  "type": "Example",
  "number": "2.17.4",
...
},
{
  "id": "proc_submodule",
  "level": "2",
  "url": "s_modules.html#proc_submodule",
  "type": "Procedure",
  "number": "2.17.6",
  "title": "Submodule verification.",
  "body": " Submodule verification   Let be an -module. To prove that a subset of is a submodule, proceed as follows.   Show that .    Show that for all and , if , then . Using logical shorthand, prove the following implication: .      "
},
{
  "id": "s_modules-9",
  "level": "2",
  "url": "s_modules.html#s_modules-9",
  "type": "Proof",
  "number": "2.17.1",
  "title": "Proof of Procedure 2.17.6.",
  "body": " Proof of   The fact that our two-step procedure is equivalent to verifying the conditions of the definition follows from the following observations:   Taking in the second step shows that is closed under addition.    Taking and and using the fact that in any -module (prove this yourself!), we see that is closed under additive inverses.    Taking and arbitrary shows that is closed under scalar multiplication.     "
},
{
  "id": "d_module_homo",
  "level": "2",
...
},
{
  "id": "s_modules-15",
  "level": "2",
  "url": "s_modules.html#s_modules-15",
  "type": "Remark",
  "number": "2.17.11",
...
},
{
  "id": "s_PID_mod_proofs",
  "level": "1",
  "url": "s_PID_mod_proofs.html",
  "type": "Section",
  "number": "2.20",
  "title": "PID-module structure theorems: proofs",
  "body": " PID-module structure theorems: proofs   Proof of uniqueness  We first examine the uniqueness claims in and . In proving this we will assume existence of decompositions of the given form.  Let's first see why the Betti number is uniquely determined. If we have , then and thus . Thus is the rank of the free module . Since the rank of a free module is well defined, we see that is uniquely determined by the module . More explicitly, we have .  It remains to show that each of the two distinct decompositions of described in and satisfy the specified uniqueness claims. First observe that the we can obtain the elementary divisor form from the invariant factor form using the Chinese remainder theorem: given , with pairwise nonassociate irreducibles, the ideals are pairwise coprime, and thus . Expanding out all the invariant factor quotients in this way and then grouping all associate irreducible factors together, we obtain the elementary divisor form from the invariant factor form. Conversely, with a little bit of care you can group the elementary factor quotients together in such a way to get the invariant factor form. It is worth at least looking at one example of this reverse direction to see what the subtleties are. Consider the case and the group . We have . It thus suffices to show that the uniqueness claim for the elementary divisor form holds. Since this decomposition is a decomposition of , we will assume is torsion. Suppose we have a decomposition where the are pairwise nonassociate irreducible elements. In general, if and are nonassociate irreducible elements, then and are coprime for any positive integer , from which it follows that multiplication by is an automorphism of . It follows that the -primary component of is for any irreducible not associate to and positive integer . Since -primary components behave well with direct sums, we conclude that given the composition of above, we have for all . In other words, not surprisingly, we extract from the decomposition above by taking just the direct summands that involve . Since is (up to isomorphism) uniquely determined by , we have thus reduced the uniqueness problem to showing that each of these -primary component decompositions is unique in the stipulated sense. From now on, we assume that is an irreducible element, and that we have a module with decomposition . The uniqueness of the appearing in such a decomposition is now given by the following result, which actually tells us how to compute the sequence .   PID-module -primary components   Let be a PID, let be an irreducible element of , and let . Note that since is a maximal ideal in , is a field.   If is a finitely generated -module, then for all , is a finite-dimensional -vector space. In particular, is a -vector space of finite dimension .    Let for some positive integer . We have     Suppose is a finitely generated -module satisfying with . For each , define . We have . It follows that the sequence is uniquely determined by .          First observe that for any -module and element (irreducible or not), we have . Now take irreducible in . For each , the set is an -submodule of , and we have . As always, the quotient module is a group with respect to coset addition. To show it is an -module we must define a scalar multiplication by elements of . We do so as follows: given and , we define . As always, once we show that this operation is well defined, that it satisfies the four scalar multiplication axioms then follows from the fact that is an -module. If we have and , then for some and for some . But then we have . Since , , and thus . We conclude that , as desired.    Note that . If , then since for all , we have , and thus . It follows that .  Now assume that , in which case . Using coset notation, we have for all . Since , the third isomorphism theorem implies . Lastly, the homomorphism defined as is clearly surjective with kernel . Thus , as desired.    First note that given any direct sum , we have . Thus given , we have , and thus , where , the number of exponents that are (strictly) greater than . It follows that , and thus that , where is the number of exponents that are greater than , but not greater than . This is precisely the number of exponents equal to .       Let's see the dimension formula at work in the setting , where an -module is nothing more than an abelian group.   -primary components   Verify formula for the -module .    We compute and thus . We conclude that . Following the argument in the proof of , these dimensions tells us that the decomposition of has 3 summands of the form with , 1 summand of the form with , and 1 summand of the form with . Lastly, we have . As per , this means has exactly 2 summands of the form , no summands of the form , and exactly 1 summand of the form . This is precisely the decomposition we started with.      Aligned bases  We now set about proving that the decompositions described in exists for any finitely generated -module, where is a PID. Let be a finitely generated -module. From the surjective -module homomorphism , we conclude from the first isomorphism theorem that , where . We desire a nice computational technique for determining the quotient : one that will hopefully give us the decomposition of as in . The next theorem provides exactly this.   PID-module theorem: aligned bases   Let be a PID. Let be free -module of finite rank , and let be a nonzero submodule of .    is a free -module and .    There is a basis of and nonzero elements , , such that for all , and is a basis of .       This is a consequence of and , which are discussed in the next subsection. In more detail, since is free, and since our statements are invariant under isomorphism, we may assume for some positive integer , and that is a submodule. By , is finitely generated. Thus we have for some elements . Letting be the matrix whose -th column is (considered as a column vector), and letting be the corresponding homomorphism from to , we have . then tells us that there is an aligned basis of with respect to .     Aligned basis   Let be a commutative ring, let be a free -module, and let be a free submodule of . An aligned basis for and is a basis of such that there is a subset and tuple of elements in such that is a basis of .     Aligned basis for as -module   Let , the ring of Gaussian integers, and let .   Show that , considered as a -module, is free of rank 2.    Let be the ideal of generated by : , . Show that is a free -module of rank 2, and that is a -basis of .    Note that the standard -basis of is not an aligned basis of and . Show that is an aligned basis for and .          The tuple is easily seen to be a -basis of . Thus .    The map defined as is an -module homomorphism: . The image is , which is precisely the ideal generated by in . In other words, . The kernel of is trivial since is an integral domain! Thus is an isomorphism of with . It follows that . In more detail, since is a basis of , its image is a -basis of .    Suppose by contradiction that is an aligned basis of with respect to . This would mean that there are integers with such that is a generating set of . However, is the ideal generated by , which an irreducible element of lying over . It follows that . Since , we must have and . But then for all elements of : a contradiction, since .  The tuple is easily seen to be linearly independent. Since , it follows that is a spanning set of as a -module. Lastly, we show that is a basis of . Since it is obtained from simply by scaling each basis element by a nonzero scalar, it is clearly linearly independent. Since and since , it follows that is a spanning set of .        Aligned bases   allows us to visualize what is special about an aligned basis. In we see how the shaded parallelogram formed by the nonstandard basis of fits nicely into one of the fundamental parallelograms of the aligned basis of . Indeed, we see that exactly 5 of the smaller parallelograms combine to form the larger one. This is a reflection of the algebraic relation between the two bases: .    Lattice picture of bases of and    Lattice picture of basis of    Lattice picture of basis (1+2i, -2+i)      Lattice picture of aligned bases and   Lattice picture of basis 1+2i, 5i       We postpone a proof of the existence of aligned bases to the next subsection. We will end the current section with a proof of the existence of the decompositions described in assuming the existence of aligned bases.   Proof of invariant factor decomposition, assuming existence of aligned bases  Let be a finitely generated module over the PID . Given spanning tuple for , the -module homomorphism defined as is surjective, and thus we have . From , there is a basis of and nonzero elements , such that for all , and is a basis of . (In particular, is itself free of rank .) We claim . Indeed, let be the -module homomorphism defined as , where for all . The usual mapping properties of guarantee that is an -module homomorphism, and clearly is surjective. Lastly, given , we have . This shows that and thus that , as desired.     Proof of existence of aligned bases  According to to the aligned basis theorem, every submodule of a finite free module over a PID is itself finite free. In particular, it follows that should be finitely generated as an -module. This weaker condition is in fact true in much greater generality, as the following result indicates. We omit the proof here for now, despite it being not too difficult. You can check the text.   Finitely generated modules over Noetherian ring   Let be a commutative Noetherian ring, and let be a finitely generated -module. Every submodule of is finitely generated.    See text.    The next result allows us to identify a submodule of as the image for some -module homomorphism , and thus any finitely generated module as . This will be useful to us, as we can compute essentially as the column space of a matrix using a method much like Gaussian elimination.   Finite presentations over PID   Let be a finitely generated module over the PID . There is a sequence of -module homomorphisms such that .    Writing , the map defined as is a surjective -module homomorphism. Since is a submodule of , it is finitely generated by . Thus we have for some . Define the homomorphism as . It is clear that . Since , we conclude that .     Standard matrix representation   Let be a commutative ring, let , and let , be the standard bases of and , respectively. The standard matrix of is the matrix , where the coefficients are the unique scalars satisfying for all and .    The next result can be summarized as saying that the standard matrix of a homomorphism tells us everything we want to know about . This is a straightforward generalization of results about matrix representations of linear transformations you probably have seen in a linear algebra course.   Standard matrices   Let be a commutative ring, and let , , be positive integers.   For each , let be its standard matrix. The map is an isomorphism of -modules.  Furthermore, identifying tuples as column vectors, we have for all .  Lastly, letting be the -th column of for all , we have . In other words, is the span of the columns of .    Given and , we write for the composition and .    The map is an isomorphism of rings (and -modules).    Let . The following statements are equivalent.    is an isomorphism.     is invertible.    The columns of form a basis of .   As a result the map is an isomorphism.       Statements (1) and (2) are proven exactly as with the corresponding results for matrix representations of linear transformations of vectors spaces. Statement (3) is equivalent to (1)+(2); and statement (4) is a consequence of (3), and the fact that the tuple of columns of a matrix is equal to the tuple obtained by applying to the standard basis of .     Tuples shall be column vectors; morphisms shall be matrices   In line with , we will conflate a tuple with the corresponding column vector , . Similarly we will conflate a matrix with its corresponding homomorphism defined as for all .     Smith normal form   Let be a PID, let , and let be the standard matrix of .   There are invertible matrices and such that is a diagonal matrix with diagonal entries , , satisfying .    Let be the -th column of for all . The tuple is a basis of , and is a spanning set of . In particular, is an aligned basis for .          In we describe an algorithm for reducing to the diagonal matrix of the desired form using a series of elementary row and column operations. This is done only for Euclidean domains , but the procedure can be generalized for general PIDs. (Search up Smith normal form for PIDs.) Just as in linear algebra, a row operation can be represented as multiplication on the left by a certain invertible matrix; similarly, a column operation can be represented as multiplication on the right by a certain invertible matrix. As a result the sequence of row operations can be represented by multiplication on the left by an invertible matrix , and the sequence of column operations can be represented as multiplication on the right by an invertible matrix .    In what follows, we conflate tuples with column vectors and homomorphisms with matrices, as in . In particular, we make the identification .  First observe that we have , since is invertible. This shows that .  In a similar vein, we have . We conclude that . Since is invertible, it thus defines an isomorphism with inverse . Since is invertible, its columns form a basis of . Since is diagonal, it is easy to see that has spanning set , where as usual is the -th standard basis element of . Since is an isomorphism, applying to the spanning set yields the spanning set of . It follows that is an aligned basis of with respect to , as claimed.  The commutative diagram in summarizes the relationship between and , as goverened by the invertible matrices and .        versus ,   Commutative diagram relating image of A and image of D=QAP      Elementary operations   Let be a commutative ring, and let and be positive integers. Recall that is the matrix whose -th entry is 1, and all of whose other entries are zero. The following operations on are called the elementary row and column operations .   Scale by unit  The scaling operation multiplies all elements of a single row (or single column) of a matrix by a unit .    Row\/column swap  A row swap replaces the -th row with the -th and replaces the -th row with the -th for some .  Similarly, a column swaw replaces the -th column with the -th and replaces the -th column with the -th for some .    Row\/column addition  A row addition operation replaces the -th row with the -th row plus any scalar multiple of the -th row for some   Similarly, a column addition replaces the -th column with the -th column plus any scalar multiple of the -th column for some .        Elementary operations  As in normal linear algebra, the elementary row operations can be represented by multiplication on the left (for rows) or right (for columns) by the matrix obtained by performing the same operation on the identity matrix of appropriate dimension. Such matrices are easily shown to be invertible (with inverse matrix corresponding to the reverse operation), and are called elementary matrices .    Smith normal form: Euclidean domains   Let be a Euclidean domain with Euclidean size function , and let . To reduce to the diagonal matrix described in , proceed as follows.   Step 1  If , stop. Otherwise use row and\/or column operations to replace the first entry of with , any entry of minimal size with respect to the size function .    Step 2  Use row and column additions in conjuction with the division algorithm to replace all other entries besides in the first row and first column with zeros. If at some point a nonzero element of size less than is produced anywhere in the matrix, then return to Step 1.    Step 3  If or , stop. Otherwise, let be the submatrix of consisting of rows 2 through and columns through . If for some , bring into the first column using a column addition and return to Step 1 applied to . Otherwise, we have for all , in which case we apply Step 1 to .        Smith normal form for general PID  A similar procedure can be used in the case where is a PID, and not necessarily a Euclidean domain. In this case we replace the Euclidean size function with the function defined as follows: given nonzero , if is a unit, then define ; otherwise, define to be the number of irreducible factors (counting multipliciy) in an irreducible factorization of . This function is well defined thanks to the uniqueness property of irreducible factorizations in a PID. Although does not necessarily satisfy the division algorithm, for any two nonzero elements and with , if , then , for any GCD of and . Since is a PID, we can write for some . Using this fact, we can modify to show that for some invertible matrices and .    Aligned bases   Find an aligned basis for the given free module and submodule .    ,      ,             Computing a cokernel   Let , and let be the homomorphism with standard matrix . Express as a direct sum of cyclic groups (up to isomorphism.)         "
},
{
  "id": "th_PID_mod_pprimary",
  "level": "2",
  "url": "s_PID_mod_proofs.html#th_PID_mod_pprimary",
  "type": "Theorem",
  "number": "2.20.1",
  "title": "PID-module <span class=\"process-math\">\\(p\\)<\/span>-primary components.",
  "body": " PID-module -primary components   Let be a PID, let be an irreducible element of , and let . Note that since is a maximal ideal in , is a field.   If is a finitely generated -module, then for all , is a finite-dimensional -vector space. In particular, is a -vector space of finite dimension .    Let for some positive integer . We have     Suppose is a finitely generated -module satisfying with . For each , define . We have . It follows that the sequence is uniquely determined by .          First observe that for any -module and element (irreducible or not), we have . Now take irreducible in . For each , the set is an -submodule of , and we have . As always, the quotient module is a group with respect to coset addition. To show it is an -module we must define a scalar multiplication by elements of . We do so as follows: given and , we define . As always, once we show that this operation is well defined, that it satisfies the four scalar multiplication axioms then follows from the fact that is an -module. If we have and , then for some and for some . But then we have . Since , , and thus . We conclude that , as desired.    Note that . If , then since for all , we have , and thus . It follows that .  Now assume that , in which case . Using coset notation, we have for all . Since , the third isomorphism theorem implies . Lastly, the homomorphism defined as is clearly surjective with kernel . Thus , as desired.    First note that given any direct sum , we have . Thus given , we have , and thus , where , the number of exponents that are (strictly) greater than . It follows that , and thus that , where is the number of exponents that are greater than , but not greater than . This is precisely the number of exponents equal to .      "
},
{
  "id": "eg_primary_comp",
  "level": "2",
  "url": "s_PID_mod_proofs.html#eg_primary_comp",
  "type": "Example",
  "number": "2.20.2",
  "title": "<span class=\"process-math\">\\(p\\)<\/span>-primary components.",
  "body": " -primary components   Verify formula for the -module .    We compute and thus . We conclude that . Following the argument in the proof of , these dimensions tells us that the decomposition of has 3 summands of the form with , 1 summand of the form with , and 1 summand of the form with . Lastly, we have . As per , this means has exactly 2 summands of the form , no summands of the form , and exactly 1 summand of the form . This is precisely the decomposition we started with.   "
},
{
  "id": "th_pid_aligned_basis",
  "level": "2",
  "url": "s_PID_mod_proofs.html#th_pid_aligned_basis",
  "type": "Theorem",
  "number": "2.20.3",
  "title": "PID-module theorem: aligned bases.",
  "body": " PID-module theorem: aligned bases   Let be a PID. Let be free -module of finite rank , and let be a nonzero submodule of .    is a free -module and .    There is a basis of and nonzero elements , , such that for all , and is a basis of .       This is a consequence of and , which are discussed in the next subsection. In more detail, since is free, and since our statements are invariant under isomorphism, we may assume for some positive integer , and that is a submodule. By , is finitely generated. Thus we have for some elements . Letting be the matrix whose -th column is (considered as a column vector), and letting be the corresponding homomorphism from to , we have . then tells us that there is an aligned basis of with respect to .   "
},
{
  "id": "d_aligned_basis",
  "level": "2",
  "url": "s_PID_mod_proofs.html#d_aligned_basis",
  "type": "Definition",
  "number": "2.20.4",
  "title": "Aligned basis.",
  "body": " Aligned basis   Let be a commutative ring, let be a free -module, and let be a free submodule of . An aligned basis for and is a basis of such that there is a subset and tuple of elements in such that is a basis of .   "
},
{
  "id": "eg_gauss_ints_aligned_basis",
  "level": "2",
  "url": "s_PID_mod_proofs.html#eg_gauss_ints_aligned_basis",
  "type": "Example",
  "number": "2.20.5",
  "title": "Aligned basis for <span class=\"process-math\">\\(\\Z[i]\\)<\/span> as <span class=\"process-math\">\\(\\Z\\)<\/span>-module.",
  "body": " Aligned basis for as -module   Let , the ring of Gaussian integers, and let .   Show that , considered as a -module, is free of rank 2.    Let be the ideal of generated by : , . Show that is a free -module of rank 2, and that is a -basis of .    Note that the standard -basis of is not an aligned basis of and . Show that is an aligned basis for and .          The tuple is easily seen to be a -basis of . Thus .    The map defined as is an -module homomorphism: . The image is , which is precisely the ideal generated by in . In other words, . The kernel of is trivial since is an integral domain! Thus is an isomorphism of with . It follows that . In more detail, since is a basis of , its image is a -basis of .    Suppose by contradiction that is an aligned basis of with respect to . This would mean that there are integers with such that is a generating set of . However, is the ideal generated by , which an irreducible element of lying over . It follows that . Since , we must have and . But then for all elements of : a contradiction, since .  The tuple is easily seen to be linearly independent. Since , it follows that is a spanning set of as a -module. Lastly, we show that is a basis of . Since it is obtained from simply by scaling each basis element by a nonzero scalar, it is clearly linearly independent. Since and since , it follows that is a spanning set of .      "
},
{
  "id": "rm_aligned_bases",
  "level": "2",
  "url": "s_PID_mod_proofs.html#rm_aligned_bases",
  "type": "Remark",
  "number": "2.20.6",
  "title": "Aligned bases.",
  "body": " Aligned bases   allows us to visualize what is special about an aligned basis. In we see how the shaded parallelogram formed by the nonstandard basis of fits nicely into one of the fundamental parallelograms of the aligned basis of . Indeed, we see that exactly 5 of the smaller parallelograms combine to form the larger one. This is a reflection of the algebraic relation between the two bases: .  "
},
{
  "id": "fig_lattice_bases_pics",
  "level": "2",
  "url": "s_PID_mod_proofs.html#fig_lattice_bases_pics",
  "type": "Figure",
  "number": "2.20.7",
  "title": "",
  "body": " Lattice picture of bases of and    Lattice picture of basis of    Lattice picture of basis (1+2i, -2+i)      Lattice picture of aligned bases and   Lattice picture of basis 1+2i, 5i      "
},
{
  "id": "ss_existence-9",
  "level": "2",
  "url": "s_PID_mod_proofs.html#ss_existence-9",
  "type": "Proof",
  "number": "2.20.2.1",
  "title": "Proof of invariant factor decomposition, assuming existence of aligned bases.",
  "body": " Proof of invariant factor decomposition, assuming existence of aligned bases  Let be a finitely generated module over the PID . Given spanning tuple for , the -module homomorphism defined as is surjective, and thus we have . From , there is a basis of and nonzero elements , such that for all , and is a basis of . (In particular, is itself free of rank .) We claim . Indeed, let be the -module homomorphism defined as , where for all . The usual mapping properties of guarantee that is an -module homomorphism, and clearly is surjective. Lastly, given , we have . This shows that and thus that , as desired.  "
},
{
  "id": "th_noetherian_fg",
  "level": "2",
  "url": "s_PID_mod_proofs.html#th_noetherian_fg",
  "type": "Theorem",
  "number": "2.20.8",
  "title": "Finitely generated modules over Noetherian ring.",
  "body": " Finitely generated modules over Noetherian ring   Let be a commutative Noetherian ring, and let be a finitely generated -module. Every submodule of is finitely generated.    See text.   "
},
{
  "id": "prop_finite_presentation",
  "level": "2",
  "url": "s_PID_mod_proofs.html#prop_finite_presentation",
  "type": "Proposition",
  "number": "2.20.9",
  "title": "Finite presentations over PID.",
  "body": " Finite presentations over PID   Let be a finitely generated module over the PID . There is a sequence of -module homomorphisms such that .    Writing , the map defined as is a surjective -module homomorphism. Since is a submodule of , it is finitely generated by . Thus we have for some . Define the homomorphism as . It is clear that . Since , we conclude that .   "
},
{
  "id": "d_standard_matrix",
  "level": "2",
  "url": "s_PID_mod_proofs.html#d_standard_matrix",
  "type": "Definition",
  "number": "2.20.10",
  "title": "Standard matrix representation.",
  "body": " Standard matrix representation   Let be a commutative ring, let , and let , be the standard bases of and , respectively. The standard matrix of is the matrix , where the coefficients are the unique scalars satisfying for all and .   "
},
{
  "id": "prop_std_matrix",
  "level": "2",
  "url": "s_PID_mod_proofs.html#prop_std_matrix",
  "type": "Proposition",
  "number": "2.20.11",
  "title": "Standard matrices.",
  "body": " Standard matrices   Let be a commutative ring, and let , , be positive integers.   For each , let be its standard matrix. The map is an isomorphism of -modules.  Furthermore, identifying tuples as column vectors, we have for all .  Lastly, letting be the -th column of for all , we have . In other words, is the span of the columns of .    Given and , we write for the composition and .    The map is an isomorphism of rings (and -modules).    Let . The following statements are equivalent.    is an isomorphism.     is invertible.    The columns of form a basis of .   As a result the map is an isomorphism.       Statements (1) and (2) are proven exactly as with the corresponding results for matrix representations of linear transformations of vectors spaces. Statement (3) is equivalent to (1)+(2); and statement (4) is a consequence of (3), and the fact that the tuple of columns of a matrix is equal to the tuple obtained by applying to the standard basis of .   "
},
{
  "id": "fiat_matrix_morphism",
  "level": "2",
  "url": "s_PID_mod_proofs.html#fiat_matrix_morphism",
  "type": "Fiat",
  "number": "2.20.12",
  "title": "Tuples shall be column vectors; morphisms shall be matrices.",
  "body": " Tuples shall be column vectors; morphisms shall be matrices   In line with , we will conflate a tuple with the corresponding column vector , . Similarly we will conflate a matrix with its corresponding homomorphism defined as for all .   "
},
{
  "id": "th_smith_normal_form",
  "level": "2",
  "url": "s_PID_mod_proofs.html#th_smith_normal_form",
  "type": "Theorem",
  "number": "2.20.13",
  "title": "Smith normal form.",
  "body": " Smith normal form   Let be a PID, let , and let be the standard matrix of .   There are invertible matrices and such that is a diagonal matrix with diagonal entries , , satisfying .    Let be the -th column of for all . The tuple is a basis of , and is a spanning set of . In particular, is an aligned basis for .          In we describe an algorithm for reducing to the diagonal matrix of the desired form using a series of elementary row and column operations. This is done only for Euclidean domains , but the procedure can be generalized for general PIDs. (Search up Smith normal form for PIDs.) Just as in linear algebra, a row operation can be represented as multiplication on the left by a certain invertible matrix; similarly, a column operation can be represented as multiplication on the right by a certain invertible matrix. As a result the sequence of row operations can be represented by multiplication on the left by an invertible matrix , and the sequence of column operations can be represented as multiplication on the right by an invertible matrix .    In what follows, we conflate tuples with column vectors and homomorphisms with matrices, as in . In particular, we make the identification .  First observe that we have , since is invertible. This shows that .  In a similar vein, we have . We conclude that . Since is invertible, it thus defines an isomorphism with inverse . Since is invertible, its columns form a basis of . Since is diagonal, it is easy to see that has spanning set , where as usual is the -th standard basis element of . Since is an isomorphism, applying to the spanning set yields the spanning set of . It follows that is an aligned basis of with respect to , as claimed.  The commutative diagram in summarizes the relationship between and , as goverened by the invertible matrices and .      "
},
{
  "id": "fig_imA_imD",
  "level": "2",
  "url": "s_PID_mod_proofs.html#fig_imA_imD",
  "type": "Figure",
  "number": "2.20.14",
  "title": "",
  "body": " versus ,   Commutative diagram relating image of A and image of D=QAP    "
},
{
  "id": "d_elem_ops",
  "level": "2",
  "url": "s_PID_mod_proofs.html#d_elem_ops",
  "type": "Definition",
  "number": "2.20.15",
  "title": "Elementary operations.",
  "body": " Elementary operations   Let be a commutative ring, and let and be positive integers. Recall that is the matrix whose -th entry is 1, and all of whose other entries are zero. The following operations on are called the elementary row and column operations .   Scale by unit  The scaling operation multiplies all elements of a single row (or single column) of a matrix by a unit .    Row\/column swap  A row swap replaces the -th row with the -th and replaces the -th row with the -th for some .  Similarly, a column swaw replaces the -th column with the -th and replaces the -th column with the -th for some .    Row\/column addition  A row addition operation replaces the -th row with the -th row plus any scalar multiple of the -th row for some   Similarly, a column addition replaces the -th column with the -th column plus any scalar multiple of the -th column for some .      "
},
{
  "id": "ss_aligned_basis-13",
  "level": "2",
  "url": "s_PID_mod_proofs.html#ss_aligned_basis-13",
  "type": "Remark",
  "number": "2.20.16",
  "title": "Elementary operations.",
  "body": " Elementary operations  As in normal linear algebra, the elementary row operations can be represented by multiplication on the left (for rows) or right (for columns) by the matrix obtained by performing the same operation on the identity matrix of appropriate dimension. Such matrices are easily shown to be invertible (with inverse matrix corresponding to the reverse operation), and are called elementary matrices .  "
},
{
  "id": "proc_smith_normal",
  "level": "2",
  "url": "s_PID_mod_proofs.html#proc_smith_normal",
  "type": "Procedure",
  "number": "2.20.17",
  "title": "Smith normal form: Euclidean domains.",
  "body": " Smith normal form: Euclidean domains   Let be a Euclidean domain with Euclidean size function , and let . To reduce to the diagonal matrix described in , proceed as follows.   Step 1  If , stop. Otherwise use row and\/or column operations to replace the first entry of with , any entry of minimal size with respect to the size function .    Step 2  Use row and column additions in conjuction with the division algorithm to replace all other entries besides in the first row and first column with zeros. If at some point a nonzero element of size less than is produced anywhere in the matrix, then return to Step 1.    Step 3  If or , stop. Otherwise, let be the submatrix of consisting of rows 2 through and columns through . If for some , bring into the first column using a column addition and return to Step 1 applied to . Otherwise, we have for all , in which case we apply Step 1 to .      "
},
{
  "id": "ss_aligned_basis-15",
  "level": "2",
  "url": "s_PID_mod_proofs.html#ss_aligned_basis-15",
  "type": "Remark",
  "number": "2.20.18",
  "title": "Smith normal form for general PID.",
  "body": " Smith normal form for general PID  A similar procedure can be used in the case where is a PID, and not necessarily a Euclidean domain. In this case we replace the Euclidean size function with the function defined as follows: given nonzero , if is a unit, then define ; otherwise, define to be the number of irreducible factors (counting multipliciy) in an irreducible factorization of . This function is well defined thanks to the uniqueness property of irreducible factorizations in a PID. Although does not necessarily satisfy the division algorithm, for any two nonzero elements and with , if , then , for any GCD of and . Since is a PID, we can write for some . Using this fact, we can modify to show that for some invertible matrices and .  "
},
{
  "id": "eg_aligned_bases",
  "level": "2",
  "url": "s_PID_mod_proofs.html#eg_aligned_bases",
  "type": "Example",
  "number": "2.20.19",
  "title": "Aligned bases.",
  "body": " Aligned bases   Find an aligned basis for the given free module and submodule .    ,      ,           "
},
{
  "id": "eg_coker",
  "level": "2",
  "url": "s_PID_mod_proofs.html#eg_coker",
  "type": "Example",
  "number": "2.20.20",
  "title": "Computing a cokernel.",
  "body": " Computing a cokernel   Let , and let be the homomorphism with standard matrix . Express as a direct sum of cyclic groups (up to isomorphism.)       "
},
{
  "id": "s_PID_mod_Jordan",
  "level": "1",
  "url": "s_PID_mod_Jordan.html",
  "type": "Section",
  "number": "2.21",
  "title": "PID-module structure theorems: Jordan canonical forms",
  "body": " PID-module structure theorems: Jordan canonical forms  Amazingly, by treating the case , where is a field, the PID-module structure theorems gives us some advanced theory about linear transformations for finite-dimensional -vector spaces essentially for free! Before getting into details, we first make an observation about modules over a general polynomial ring.   Modules over a polynomial ring   Let be a commutative ring.  If is an -module, then in particular is an -module, and the map defined as is an -module endomorphism of .  Conversely, if is an -module and is an -module endomorphism of , then can be a given an -module structure by defining .  In other words, an -module consists of an -module , together with a choice of that determines how elements of are multiplied by .    Proof by delegation.    The proposition is the key that will allow us to connect linear transformations of vector spaces to the PID-module structure theory. Firstly, if is a field, then we know that is a PID. Now, let be a finite-dimensional -vector space, and let be a linear transformation of . Using the language of module theorem, is a finite free -module, and is an -endomorphism of .  According to our proposition, inherits an -module structure from by defining , and more generally, . Since is finitely generated over , it is certainly finitely generated over . We conclude that as an -module, we have for some polynomials . Next, since is a finite-dimensional -vector space and is an infinite-dimensional -vector space, we must have and . Great, but what does this tell us about the linear transformation ?   Minimal and characteristic polynomial   Let be a field, let be a finite-dimensional -vector space, and let be a linear transformation.   Characteristic polynomial  The characteristic polynomial of is the polynomial defined as , where is a(ny) matrix representation of with respect to a a basis of .    The minimal polynomial of is the unique monic polynomial of minimal degree satisfying .        Minimal and characteristic polynomial  Assume is a -dimensional -vector space, and let be a linear transformation. The minimal polynomial is the unique monic generator of . By the Cayley-Hamilton theorem (proved in great generality in your homework), we have , and thus .    Jordan decomposition   Let be an -dimensional -vector space, and let be a nonzero linear transformation.   There exists a unique sequence of nonconstant monic polynomials satisfying for all and .    There exists a unique set of distinct monic irreducible polynomials , and for each a unique sequence of positive integers such that .             Let be an -dimensional -vector space, and let be a nonzero linear transformation. We treat as an -module via the action of on .   Let be the monic invariant factors of . We have .    Let be the distinct monic irreducible polynomials appearing in the elementary factors decomposition of , and for each , let be the accompanying unique sequence of integers. We have .       "
},
{
  "id": "prop_mods_poly_ring",
  "level": "2",
  "url": "s_PID_mod_Jordan.html#prop_mods_poly_ring",
  "type": "Proposition",
  "number": "2.21.1",
...
{
  "id": "d_minimal_char_poly",
  "level": "2",
  "url": "s_PID_mod_Jordan.html#d_minimal_char_poly",
  "type": "Definition",
  "number": "2.21.2",
  "title": "Minimal and characteristic polynomial.",
  "body": " Minimal and characteristic polynomial   Let be a field, let be a finite-dimensional -vector space, and let be a linear transformation.   Characteristic polynomial  The characteristic polynomial of is the polynomial defined as , where is a(ny) matrix representation of with respect to a a basis of .    The minimal polynomial of is the unique monic polynomial of minimal degree satisfying .      "
},
{
  "id": "s_PID_mod_Jordan-7",
  "level": "2",
  "url": "s_PID_mod_Jordan.html#s_PID_mod_Jordan-7",
  "type": "Remark",
  "number": "2.21.3",
  "title": "Minimal and characteristic polynomial.",
  "body": " Minimal and characteristic polynomial  Assume is a -dimensional -vector space, and let be a linear transformation. The minimal polynomial is the unique monic generator of . By the Cayley-Hamilton theorem (proved in great generality in your homework), we have , and thus .  "
},
{
  "id": "th_Jordan_decomp",
  "level": "2",
  "url": "s_PID_mod_Jordan.html#th_Jordan_decomp",
  "type": "Theorem",
  "number": "2.21.4",
  "title": "Jordan decomposition.",
  "body": " Jordan decomposition   Let be an -dimensional -vector space, and let be a nonzero linear transformation.   There exists a unique sequence of nonconstant monic polynomials satisfying for all and .    There exists a unique set of distinct monic irreducible polynomials , and for each a unique sequence of positive integers such that .          "
},
{
  "id": "cor_min_char_poly",
  "level": "2",
  "url": "s_PID_mod_Jordan.html#cor_min_char_poly",
  "type": "Corollary",
  "number": "2.21.5",
  "title": "",
