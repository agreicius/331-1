...
},
{
  ...
  "body": " Finite presentations over PID   Let be a finitely generated module over the PID . There is a sequence of -module homomorphisms such that .   "
},
{
...
},
{
  ...
  "body": " Smith normal form   Let be a PID, let , and be the standard matrix of .   There are invertible matrices and such that is a diagonal matrix with diagonal entries , , satisfying .    Let be the -th column of for all . The tuple is a basis of , and is a spanning set of . In particular, is an aligned basis for .       We describe an algorithm for reducing to the diagonal matrix of the desired form using a series of elementary row and column operations. This is done only for Euclidean domains , but the procedure can be generalized for general PIDs. (Search up Smith normal form for PIDs.) The row operations are packaged together to make up the matrix and the column operations go into the matrix .   "
},
{
