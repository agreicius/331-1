...
},
{
  ...
  "level": "2",
  "url": "s_products_direct_semi.html#spec_semidirect_product",
  "type": "Specimen",
  "number": "16",
...
},
{
  "id": "prop_homs_cyclic",
  "level": "2",
  "url": "s_products_direct_semi.html#prop_homs_cyclic",
  "type": "Proposition",
  "number": "1.191",
  "title": "Homomorphisms from cyclic groups.",
  "body": " Homomorphisms from cyclic groups   Let be a cyclic group, and let be a group.   If , then the map gives a bijection between and elements of . In more detail, for all , there is a unique such that for all .    If , then the map is a bijection. In more detail, for all , there is a unique satisfying such that for all .      "
},
{
  ...
  "body": " Automorphism groups      Let , with . The map is an isomorphism. In particular, we have . Additionally, if is prime, then is a cyclic group of cardinality .    If , and , , and , then .     for any positive integer .  In particular, .     for all .     for any .          "
},
{
  "id": "prop_semi_choice",
  "level": "2",
