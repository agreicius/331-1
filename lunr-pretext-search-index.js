...
{
  "id": "eg_groups_card_20",
  "level": "2",
  "url": "s_semidirect_products.html#eg_groups_card_20",
  "type": "Example",
  "number": "1.195",
  "title": "Groups of cardinality <span class=\"process-math\">\\(20\\)<\/span>.",
  "body": " Groups of cardinality   Give a classification of all groups of cardinality , up to isomorphism.    We have . The usual Sylow arguments show that . Thus has a unique normal -Sylow subgroup . Let . We have (counting argument) and thus (counting argument). It follows from that for some homomorphism .   "
},
{
