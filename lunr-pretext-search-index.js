...
},
{
  ...
  "number": "1.31",
  "title": "Isometry.",
  "body": "   isometries of   Isometry   Fix a positive integer . Let denote the standard Euclidean distance on : , , for all -tuples and . An isometry (or rigid motion ) of with respect to is a function satisfying for all . We denote by the set of all isometries of .   "
},
{
  "id": "spec_isom",
  "level": "2",
...
},
{
  ...
  "number": "1.41",
  "title": "Cycles.",
  "body": " Cycles   Let be -tuple of distinct elements of the set . The permutation defined as is called the k-cycle of associated to the tuple , and is denoted . Two cycles are disjoint if .   "
},
{
  "id": "prop_cycle_arith",
  "level": "2",
  ...
  "body": " Cycle arithmetic   Let and be cycles of the set .   For all , we have .     .         If and are disjoint, then : , disjoint cycles commute.    If , where the are pairwise disjoint cycles, then the order of is the least common multiple of the orders of the : , .      "
},
{
  ...
  "body": " Cycle decomposition   Let be a finite set, and let .   We can write where the are pairwise disjoint cycles.    The set of disjoint cycles appearing in the decomposition is uniquely determined by .          "
},
{
