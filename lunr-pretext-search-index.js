...
},
{
  ...
  "body": " PID-module -primary components   Let be a PID, let be an irreducible element of , and let . Note that since is a maximal ideal in , is a field.   If is a finitely generated -module, then for all , is a finite-dimensional -vector space. In particular, is a -vector space of finite dimension .    Let for some positive integer . We have     Suppose is a finitely generated -module satisfying with . For each , define . We have . It follows that the sequence is uniquely determined by .          "
},
{
  ...
  "body": " PID-module theorem: aligned bases   Let be a PID. Let be free -module of finite rank , and let be a nonzero submodule of .    is a free -module and .    There is a basis of and nonzero elements , , such that for all , and is a basis of .          "
},
{
  "id": "d_aligned_basis",
  "level": "2",
...
},
{
  ...
  "body": " Standard matrices   Let be a commutative ring, and let , , be positive integers.   For each , let be its standard matrix. The map is an isomorphism of -modules.  Furthermore, identifying tuples as column vectors, we have for all .  Lastly, letting be the -th column of for all , we have . In other words, is the span of the columns of .    Given and , we write for the composition and .    The map is an isomorphism of rings (and -modules).    Let . The following statements are equivalent.    is an isomorphism.     is invertible.    The columns of form a basis of .   As a result the map is an isomorphism.       We prove (1) and (2) exactly as we do for the corresponding results for matrix representations of linear transformations of vectors spaces. (In other words, we leave the proof to you.) Statement (3) then follows from fact that .   "
},
{
